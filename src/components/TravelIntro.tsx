    ...
    <AnimatePresence>
      {showIntro && (
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pb-12 md:pb-20 w-full space-y-5">
            <motion.div
            ...
            >
              <div className="relative h-[2px] w-40 bg-white/15 rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: '100%' }}
              ...
              <button
                ...
                onMouseLeave={() => setCursorState?.({ type: 'default' })}
                className="group inline-flex items-center gap-2 font-mono text-xs tracking-[0.2em] text-warmPaper hover:text-accent-gold uppercase transition-colors px-4 py-2 rounded-full bg-white/5 border border-white/15 hover:border-accent/40"
              >
