...
import { MapPin, Calendar, ArrowRight, ArrowLeft, Heart, X, Compass, Filter } from 'lucide-react';
...
export const Travel: React.FC<TravelProps> = ({ setCursorState }) => {
  ...
  const filteredPlaces = activeFilter === 'ALL'
    ? travelPlaces
    : travelPlaces.filter(p => p.region.toLowerCase().includes(activeFilter.toLowerCase().split(' ')[0]));
  ...
  return (
    <section id="travel" className="py-24 md:py-36 px-6 md:px-12 bg-bg-surface/30 relative border-t border-border-subtle">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        {/* Focused Interactive Bangladesh Map */}
        <TravelMap
        ...
        {/* Expedition Cards Horizontal Carousel */}
        <div
          ref={scrollRef}
